          ...
          <form className='flex flex-col sm:flex-row gap-4'>
              ...
              <textarea type="text" placeholder='Description' className='border p-3 rounded-lg' id="description" required />
                  ...
                  <div className='flex gap-6 flex-wrap'>
                      ...
                      <div className='flex items-center gap-2'>
                          <input type="number" id='discountPrice' min="1" max="10" required className='p-2 border border-gray-300 rounded-lg' />
                          <div className='flex flex-col items-center'>
              ...
              <div className='flex flex-col flex-1 gap-4'>
                  ...
                  <div className='flex gap-4'>
                      <input type="file" className='p-3 border border-gray-300 rounded w-full' name="image" id="images" accept='image/*' multiple />
                      <button className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opcaity-80'>Upload</button>
                  </div>
                  <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opcaity-95 disabled:opcaity-80'>Create Listing</button>
              </div>
